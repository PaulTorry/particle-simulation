const dl = new DrawLayer(document.getElementById("simulationWindow").getContext("2d"), "white", "black", "white", new Vec(200, 200))
const gl = new DrawLayer(document.getElementById("graphWindow").getContext("2d"), "white", "black", "white", new Vec(200, 200))
const G = 1
